...
<aside class="admin-sidebar">
    ...
    <nav class="sidebar-nav">
        <a href="admin_panel.php" class="nav-link <?php if (isset($currentPage) && $currentPage === 'admin_panel') {
            echo 'active';
        } ?>">
            <i class="fas fa-tachometer-alt"></i><span>داشبورد</span>
        </a>
        <a href="users_management.php" class="nav-link <?php if (isset($currentPage) && $currentPage === 'users_management') {
            echo 'active';
        } ?>">
            <i class="fas fa-users-cog"></i><span>مدیریت کاربران</span>
        </a>
        <a href="staff_management.php" class="nav-link <?php if (isset($currentPage) && $currentPage === 'staff_management') {
            echo 'active';
        } ?>">
        ...
        <a href="staff_archive.php" class="nav-link <?php if (isset($currentPage) && $currentPage === 'staff_archive') {
            echo 'active';
        } ?>">
