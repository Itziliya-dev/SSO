...
if (empty($_SESSION['permissions']['is_owner']) || empty($_SESSION['permissions']['can_view_archive'])) {
    ...
    <main class="main-content">
        ...
        <div class="admin-card">
            <div class="info-notice">
                ...
                <div><strong>توجه:</strong> استف‌های موجود در این لیست از مجموعه دیموت و حذف شده‌اند و تنها سوابق آن‌ها در اینجا نگهداری می‌شود. امکان ویرایش یا بازگردانی مستقیم از این بخش وجود ندارد.</div>
            </div>
